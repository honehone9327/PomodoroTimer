...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/2h9nQQX2K2)
...
```sh
npx nx serve pomodoro-timer
```

To create a production bundle:

```sh
npx nx build pomodoro-timer
```

To see all available targets to run for a project, run:

```sh
npx nx show project pomodoro-timer
```
